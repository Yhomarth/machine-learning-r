setwd("/home/yhomarth/Documents/Curso/R/yho/curso-r/script")
auto <- read.csv(file = "../data/tema1/auto-mpg.csv",header = TRUE, sep = ",",
                 strings.na = "",
...
auto_custom_header <- read.csv("../data/tema1/auto-mpg-noheader.csv", 
                               header = F, 
                               col.names = c("numero","Millas_por_galon",
                                             "clindros","desplazamiento",
                                             "caballo_de_potencia","peso",
